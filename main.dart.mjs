...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      IK: x0 => x0.files,
      IL: () => globalThis.Notification.requestPermission(),
      IM: x0 => x0.head,
      ...
      JL: x0 => globalThis.firebase_messaging.deleteToken(x0),
      JM: (x0,x1) => { x0.text = x1 },
      K: (exn) => {
      ...
      PK: (x0,x1,x2) => x0.insertBefore(x1,x2),
      PL: x0 => x0.fcmOptions,
      ...
      TI: x0 => new Blob(x0),
      TJ: x0 => x0.url,
      TK: x0 => x0.stopPropagation(),
      TL: x0 => x0.collapseKey,
      TM: x0 => x0.value,
      ...
      YI: x0 => x0.frameCount,
      YJ: x0 => x0.done,
      YK: (x0,x1) => { x0.scrollLeft = x1 },
      YL: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      YM: x0 => x0.assetBase,
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      ZJ: x0 => x0.cancel(),
      ZK: (x0,x1) => { x0.spellcheck = x1 },
      ZL: x0 => globalThis.firebase_messaging.getMessaging(x0),
      ZM: x0 => x0.loader,
      ...
      aL: x0 => globalThis.firebase_core.getApp(x0),
      aM: () => globalThis._flutter,
      b: (x0,x1,x2) => { x0[x1] = x2 },
      bB: o => {
        if (o === null || o === undefined) return 0;
      ...
      bL: () => globalThis.firebase_core.getApp(),
      c: o => o,
      ...
      cL: (x0,x1) => ({vapidKey: x0,serviceWorkerRegistration: x1}),
      d: (o, p) => o[p],
      dB: o => {
        if (o === null || o === undefined) return 0;
      ...
      dL: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      e: () => globalThis,
      ...
      oK: x0 => x0.location,
      oL: () => globalThis.firebase_core.getApps(),
      p: b => !!b,
      ...
      rJ: x0 => x0.click(),
      rK: x0 => x0.altKey,
      rL: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      s: () => ({}),
      ...
      sJ: (o, a) => o + a,
      sK: x0 => x0.ctrlKey,
      sL: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      t: (o, p, v) => o[p] = v,
      tB: o => {
        if (o === null || o === undefined) return 0;
      ...
      tL: () => globalThis.firebase_core.SDK_VERSION,
      u: () => [],
      ...
      uJ: x0 => x0.firstChild,
      uK: x0 => x0.code,
      uL: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      v: (a, i) => a.push(i),
