...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CN: x0 => x0.from,
      CO: (x0,x1) => x0.createMediaElementSource(x1),
      ...
      VN: x0 => x0.apiKey,
      VO: (x0,x1) => new OffscreenCanvas(x0,x1),
      W: x0 => new Array(x0),
      WB: o => {
        if (o === null || o === undefined) return 0;
      ...
      bL: x0 => x0.code,
      bM: x0 => x0.state,
      bN: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      c: o => o,
      ...
      cL: x0 => x0.repeat,
      cM: (x0,x1) => x0.getFloatTimeDomainData(x1),
      cN: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      d: (o, p) => o[p],
      dB: o => {
        if (o === null || o === undefined) return 0;
      ...
      dM: x0 => x0.fftSize,
      dN: () => globalThis.firebase_core.SDK_VERSION,
      e: () => globalThis,
      ...
      eL: x0 => x0.userAgent,
      eM: x0 => x0.state,
      eN: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      ...
      iL: (x0,x1) => x0.getItem(x1),
      iM: (x0,x1) => { x0.onmessage = x1 },
      ...
      jL: (x0,x1) => x0.key(x1),
      jM: x0 => x0.port,
      jN: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      k: o => o,
      ...
      kL: x0 => x0.length,
      kM: x0 => new Blob(x0),
      kN: (x0,x1,x2) => x0.createPolicy(x1,x2),
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      lJ: x0 => x0.cancel(),
      lK: x0 => x0.response,
      lL: (x0,x1) => x0.removeItem(x1),
      lM: x0 => x0.destination,
      lN: (x0,x1) => x0.createScriptURL(x1),
      m: () => globalThis.Math,
      ...
      mL: x0 => ({name: x0}),
      mM: (x0,x1) => x0.addModule(x1),
      mN: (x0,x1,x2) => x0.createScript(x1,x2),
      ...
      nJ: x0 => x0.headers,
      nK: x0 => x0.vendor,
      nL: (x0,x1) => x0.query(x1),
      nM: x0 => ({parameterData: x0}),
      ...
      oK: x0 => x0.navigator,
      oL: x0 => ({audio: x0}),
      oM: (x0,x1,x2) => new AudioWorkletNode(x0,x1,x2),
      oN: (o, p) => delete o[p],
      p: b => !!b,
      ...
      pI: x0 => x0.close(),
      pJ: x0 => ({type: x0}),
      pK: (x0,x1) => x0.appendChild(x1),
      pL: (x0,x1) => x0.getUserMedia(x1),
      pM: x0 => x0.audioWorklet,
      pN: (o, p, v) => o[p] = v,
      ...
      tJ: (x0,x1) => { x0.src = x1 },
      tK: (x0,x1) => { x0.download = x1 },
      tL: () => Symbol("jsBoxedDartObjectProperty"),
      tM: x0 => globalThis.firebase_messaging.deleteToken(x0),
      tN: x0 => x0.trustedTypes,
      u: () => [],
      ...
      uK: (x0,x1) => { x0.href = x1 },
      uL: x0 => x0.mediaDevices,
      uM: x0 => x0.link,
      uN: x0 => x0.trustedTypes,
      v: (a, i) => a.push(i),
      ...
      vL: x0 => x0.state,
      vM: x0 => x0.analyticsLabel,
      vN: (x0,x1) => { x0.crossOrigin = x1 },
      ...
      yL: (x0,x1,x2) => ({mimeType: x0,audioBitsPerSecond: x1,bitsPerSecond: x2}),
      yM: x0 => x0.title,
      yN: (x0,x1) => { x0.id = x1 },
      ...
      zK: x0 => x0.innerHeight,
      zL: (x0,x1) => new MediaRecorder(x0,x1),
      zM: x0 => x0.fcmOptions,
      zN: x0 => x0.pause(),
