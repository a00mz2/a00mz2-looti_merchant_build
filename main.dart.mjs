...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      DK: x0 => x0.click(),
      DL: (x0,x1) => x0.getModifierState(x1),
      DM: x0 => x0.getSettings(),
      DN: x0 => x0.apiKey,
      DO: x0 => x0.read(),
      E: (exn) => {
      ...
      FK: x0 => x0.children,
      FL: x0 => x0.altKey,
      FM: (x0,x1) => x0.removeTrack(x1),
      FN: x0 => x0.name,
      FO: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      GL: x0 => x0.ctrlKey,
      GM: x0 => x0.close(),
      GN: () => globalThis.firebase_core.getApps(),
      GO: x0 => x0.assetBase,
      ...
      JJ: x0 => x0.decode(),
      JK: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      JL: x0 => x0.repeat,
      JM: x0 => x0.state,
      JN: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      K: (exn) => {
      ...
      KM: (x0,x1) => x0.getFloatTimeDomainData(x1),
      KN: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      L: o => o === undefined,
      ...
      LL: x0 => x0.userAgent,
      LM: x0 => x0.fftSize,
      LN: () => globalThis.firebase_core.SDK_VERSION,
      M: o => String(o),
      ...
      ML: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      MM: x0 => x0.state,
      MN: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      N: (c) =>
      ...
      PM: x0 => x0.data,
      PN: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      ...
      QJ: x0 => x0.response,
      QK: (x0,x1) => x0.readAsArrayBuffer(x1),
      QL: (x0,x1) => x0.key(x1),
      QM: (x0,x1) => { x0.onmessage = x1 },
      ...
      RL: x0 => x0.length,
      RM: x0 => x0.port,
      RN: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      ...
      SK: x0 => x0.name,
      SL: (x0,x1) => x0.removeItem(x1),
      SM: x0 => new Blob(x0),
      SN: (x0,x1,x2) => x0.createPolicy(x1,x2),
      T: x0 => new Promise(x0),
      ...
      TK: x0 => x0.result,
      TL: x0 => globalThis.URL.revokeObjectURL(x0),
      TM: x0 => x0.destination,
      TN: (x0,x1) => x0.createScriptURL(x1),
      ...
      UK: x0 => x0.length,
      UL: x0 => ({name: x0}),
      UM: (x0,x1) => x0.addModule(x1),
      UN: (x0,x1,x2) => x0.createScript(x1,x2),
      V: (constructor, args) => {
      ...
      VI: (x0,x1) => x0.revokeObjectURL(x1),
      VJ: () => {
      ...
      VK: x0 => x0.files,
      VL: (x0,x1) => x0.query(x1),
      VM: x0 => ({parameterData: x0}),
      VN: (x0,x1) => x0.appendChild(x1),
      W: x0 => new Array(x0),
      WB: o => {
        if (o === null || o === undefined) return 0;
      ...
      WI: (x0,x1) => { x0.src = x1 },
      WJ: x0 => x0.abort(),
      WK: (x0,x1) => { x0.display = x1 },
      WL: x0 => ({audio: x0}),
      WM: (x0,x1,x2) => new AudioWorkletNode(x0,x1,x2),
      ...
      XH: x0 => x0.next(),
      XI: (x0,x1,x2,x3,x4) => globalThis.createImageBitmap(x0,x1,x2,x3,x4),
      XJ: () => new AbortController(),
      XK: x0 => x0.style,
      XL: (x0,x1) => x0.getUserMedia(x1),
      XM: x0 => x0.audioWorklet,
      XN: (o, p) => delete o[p],
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      ...
      aI: x0 => x0.decode(),
      aJ: (x0,x1) => x0.get(x1),
      aK: (x0,x1) => { x0.draggable = x1 },
      aL: (o,s,v) => o[s] = v,
      aM: () => globalThis.Notification.requestPermission(),
      aN: x0 => x0.head,
      b: (x0,x1,x2) => { x0[x1] = x2 },
      bB: o => {
        if (o === null || o === undefined) return 0;
      ...
      bH: () => globalThis.Intl,
      bI: (x0,x1) => { x0.decoding = x1 },
      bJ: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1,x2) { return wasmFunction(f,arguments.length,x0,x1,x2) }),
      bK: (x0,x1) => { x0.type = x1 },
      bL: () => Symbol("jsBoxedDartObjectProperty"),
      bM: x0 => globalThis.firebase_messaging.deleteToken(x0),
      bN: (x0,x1) => { x0.text = x1 },
      c: o => o,
      ...
      cI: (x0,x1) => { x0.crossOrigin = x1 },
      cJ: (x0,x1) => x0.forEach(x1),
      cK: (x0,x1) => { x0.border = x1 },
      cL: x0 => x0.mediaDevices,
      cM: x0 => x0.link,
      cN: x0 => x0.trustedTypes,
      d: (o, p) => o[p],
      dB: o => {
        if (o === null || o === undefined) return 0;
      ...
      dJ: x0 => x0.name,
      dK: (x0,x1) => { x0.objectFit = x1 },
      dL: x0 => x0.state,
      dM: x0 => x0.analyticsLabel,
      dN: x0 => x0.trustedTypes,
      e: () => globalThis,
      ...
      eL: x0 => x0.permissions,
      eM: x0 => x0.image,
      eN: (x0,x1) => { x0.crossOrigin = x1 },
      ...
      gJ: x0 => x0.status,
      gK: (x0,x1) => { x0.src = x1 },
      gL: (x0,x1,x2) => ({mimeType: x0,audioBitsPerSecond: x1,bitsPerSecond: x2}),
      gM: x0 => x0.title,
      gN: (x0,x1) => x0.querySelector(x1),
      ...
      hL: (x0,x1) => new MediaRecorder(x0,x1),
      hM: x0 => x0.fcmOptions,
      hN: (x0,x1) => { x0.id = x1 },
      i: (l, r) => l === r,
      ...
      kJ: x0 => x0.done,
      kK: x0 => x0.type,
      kL: (x0,x1) => x0.start(x1),
      kM: x0 => x0.from,
      kN: x0 => x0.currentTime,
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      lJ: x0 => x0.cancel(),
      lK: x0 => x0.response,
      lL: (x0,x1) => x0.createMediaStreamSource(x1),
      lM: x0 => x0.collapseKey,
      lN: x0 => x0.resume(),
      m: () => globalThis.Math,
      ...
      mL: x0 => x0.createAnalyser(),
      mM: x0 => x0.data,
      mN: (x0,x1) => x0.createMediaElementSource(x1),
      ...
      oJ: x0 => x0.signal,
      oK: x0 => x0.navigator,
      oL: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      oM: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      oN: x0 => x0.createStereoPanner(),
      p: b => !!b,
      ...
      pI: x0 => x0.close(),
      pJ: x0 => ({type: x0}),
      pK: (x0,x1) => x0.transferFromImageBitmap(x1),
      pL: (x0,x1) => { x0.fftSize = x1 },
      pM: (x0,x1) => ({next: x0,error: x1}),
      pN: x0 => x0.load(),
      ...
      qK: (x0,x1) => x0.getContext(x1),
      qL: (x0,x1) => { x0.onstop = x1 },
      qM: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      qN: (x0,x1) => { x0.value = x1 },
      r: (x0,x1) => x0.focus(x1),
      ...
      rL: x0 => x0.arrayBuffer(),
      rM: x0 => globalThis.firebase_messaging.getMessaging(x0),
      rN: x0 => x0.gain,
      s: () => ({}),
      ...
      sJ: (x0,x1) => { x0.preload = x1 },
      sK: (x0,x1) => { x0.width = x1 },
      sL: x0 => x0.type,
      sM: x0 => globalThis.firebase_core.getApp(x0),
      sN: x0 => x0.code,
      t: (o, p, v) => o[p] = v,
      tB: o => {
        if (o === null || o === undefined) return 0;
      ...
      tK: x0 => x0.height,
      tL: x0 => x0.mimeType,
      tM: () => globalThis.firebase_core.getApp(),
      tN: x0 => x0.message,
      u: () => [],
      ...
      uK: x0 => x0.width,
      uL: (x0,x1) => { x0.ondataavailable = x1 },
      uM: (x0,x1) => ({vapidKey: x0,serviceWorkerRegistration: x1}),
      uN: x0 => x0.error,
      v: (a, i) => a.push(i),
      ...
      vK: x0 => x0.rasterEndMilliseconds,
      vL: x0 => x0.data,
      vM: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      vN: x0 => x0.duration,
      ...
      wJ: x0 => x0.play(),
      wK: x0 => x0.rasterStartMilliseconds,
      wL: x0 => globalThis.MediaRecorder.isTypeSupported(x0),
      wM: x0 => x0.measurementId,
      wN: (x0,x1) => { x0.playbackRate = x1 },
      ...
      xH: x0 => x0.id,
      xI: (o, p) => p in o,
      xJ: (x0,x1) => { x0.currentTime = x1 },
      xK: x0 => x0.imageBitmaps,
      xL: x0 => x0.channelCount,
      xM: x0 => x0.appId,
      xN: (x0,x1) => { x0.loop = x1 },
      ...
      yK: x0 => x0.canvasKitMaximumSurfaces,
      yL: x0 => x0.sampleRate,
      yM: x0 => x0.messagingSenderId,
      ...
      zK: x0 => x0.nextSibling,
      zL: x0 => ({sampleRate: x0}),
      zM: x0 => x0.storageBucket,
      zN: x0 => x0.length,
